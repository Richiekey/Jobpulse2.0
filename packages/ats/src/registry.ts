...
export const ATS_DEFINITIONS: Record<string, ATSDefinition> = {
  ...
  rippling: {
    ...
    jobUrlPatterns: [/ats\.rippling\.com\/([^/]+)\/jobs\/([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
  ...
  jobvite: {
    ...
    jobUrlPatterns: [/jobs\.jobvite\.com\/([^/]+)\/job\/([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
  ...
  recruitee: {
    ...
    jobUrlPatterns: [/([a-zA-Z0-9_-]+)\.recruitee\.com\/o\/([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
  ...
  applytojob: {
    ...
    jobUrlPatterns: [/([a-zA-Z0-9_-]+)\.applytojob\.com\/apply\/([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
  ...
  teamtailor: {
    ...
    jobUrlPatterns: [/([a-zA-Z0-9_-]+)\.teamtailor\.com\/jobs\/([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
  ...
  breezy: {
    ...
    isImplemented: true,
    domains: ['breezy.hr'],
    jobUrlPatterns: [/([a-zA-Z0-9_-]+)\.breezy\.hr\/p\/([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
  ...
  personio: {
    ...
    jobUrlPatterns: [/([a-zA-Z0-9_-]+)\.jobs\.personio\.(?:com|de)\/job\/([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
  ...
  adp: {
    ...
    jobUrlPatterns: [/workforcenow\.adp\.com.*[?&]cid=([a-zA-Z0-9_-]+)/i],
    capabilities: {
      hasPublicApi: true,
      supportsIncrementalSync: false,
      providesStructuredData: true,
